...
BUNDLE_IDS = {
    ...
    # Telegram's installed display name includes its version (for example
    # "Telegram 12.9.2"), so exact-name discovery cannot resolve the stable
    # friendly name used by unattended storefront acceptance.
