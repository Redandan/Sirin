...
Manage the Sirin process from an external Codex session. Required
...
```bash
cd ~/IdeaProjects/Sirin
# Detach so Codex's terminal isn't held
...
> `~/.Codex/broadcasts/2026-04-25-sirin-dashboard-and-loop-closeout.md`.
